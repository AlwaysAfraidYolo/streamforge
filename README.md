...
Архитектурная эволюция проекта, C++ Core и границы MVP описаны в
[ROADMAP.md](ROADMAP.md). Для переноса разработки на Windows/WSL2 используй
[инструкцию WSL2](docs/WSL2_SETUP.md).
